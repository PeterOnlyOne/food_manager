					...
					<div class="ItemBlock2">
						<table cellpadding="0" cellspacing="0" class="mainForm">
							<tr>
								<td width="80px">菜系</td>
								<td>
									<jsp:useBean id="myCuisine" class="cn.et.model.MyCuisine"></jsp:useBean>
									<select name="typeId" style="width: 80px">
										<c:forEach var="list" items="${pageScope.myCuisine.allCuisine }">
											<option value="${pageScope.list.TYPEID }">${pageScope.list.TYPENAME }</option>
										</c:forEach>
