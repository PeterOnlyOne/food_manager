...
<body>
	...
	<div id="MainArea">
		<table class="MainArea_Content" align="center" cellspacing="0" cellpadding="0">
			...
			<!--显示数据列表 -->
			<tbody id="TableData">
				<c:forEach var="list" items="${requestScope.orderList.data }">
			 		<tr height="60">
				 		<td>${pageScope.list.ORDERID }</td>
				 		<td>${pageScope.list.DESKID }</td>
				 		<td>${pageScope.list.ORDERTIME }</td>
				 		<td>204.0</td>
				 		
				 			
				 				<td>${pageScope.list.ORDERSTATE }&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
